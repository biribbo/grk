...
void renderScene(GLFWwindow* window)
{
	...
	glm::mat4 rotationStatic = glm::eulerAngleXYZ(glm::radians(30.0f), glm::radians(45.0f), glm::radians(0.0f));

	glm::mat4 rotationDynamic = glm::eulerAngleXYZ(0.0f, time, 0.0f);

	glm::mat4 transformation = rotationStatic * rotationDynamic;
...
void init(GLFWwindow* window)
{
	...
	glVertexAttribPointer(locationIndex, 4, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void *)0);
	glVertexAttribPointer(colorIndex, 4, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void *)(4 * sizeof(float)));
